...
import SubtreeRetainer from 'duroom/common/utils/SubtreeRetainer';
import CommentPost from 'duroom/forum/components/CommentPost';
import UserCard from 'duroom/forum/components/UserCard';
import DiscussionHero from 'duroom/forum/components/DiscussionHero';
    ...
    attrs.ondrop = (event: DragEvent) => {
        ...
        if (fishId) {
            ...
            if (fish) {
                ...
                alert(app.translator.trans('duroom-catch-the-fish.forum.drop-area.missing-from-store'));
            }
        }
    };
