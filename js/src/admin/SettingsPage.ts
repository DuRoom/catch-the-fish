...
const translationPrefix = 'duroom-catch-the-fish.admin.settings.';
...
export default class SettingsPage extends ExtensionPage {
    ...
    oninit(vnode: Vnode) {
        ...
        if (duroom.extensions['duroom-tags']) {
            this.loadAllTags();
        }
    }
    ...
    tagSettings(): any {
        ...
        duroom.core.compat['tags/utils/sortTags'](app.store.all('tags')).forEach(tag => {
