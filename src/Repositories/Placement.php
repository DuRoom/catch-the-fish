...
class Placement
{
    ...
    public function assertValid(): void
    {
        ...
        if ($model instanceof Discussion || $model instanceof Post) {
            ...
            if ($extensions->isEnabled('duroom-tags') && is_array($tagSettings) && count($tagSettings)) {
        ...
        if ($model instanceof Discussion) {
            ...
            if ($extensions->isEnabled('duroom-suspend') && !is_null($model->suspended_until) && $model->suspended_until->gt(Carbon::now())) {
                throw new ValidationException([
    ...
    protected static function randomUser(): ?User
    {
        ...
        if ($extensions->isEnabled('duroom-suspend')) {
